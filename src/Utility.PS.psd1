...
NestedModules = @(
    ...
    '.\Expand-Data.ps1'
    '.\Format-DataSize.ps1'
    '.\Format-NumberWithMetricUnit.ps1'
    '.\Format-PropertyValue.ps1'
    '.\Get-ContentEncoding.ps1'
    '.\Get-PropertyValue.ps1'
    '.\Get-RelativePath.ps1'
    '.\Get-StrictModeVersion.ps1'
    '.\Get-X509Certificate.ps1'
    '.\Get-X509CertificateCrlDistributionPoints.ps1'
...
FunctionsToExport = @(
    ...
    'Expand-Data'
    'Format-DataSize'
    'Format-NumberWithMetricUnit'
    'Format-PropertyValue'
    'Get-ContentEncoding'
    'Get-PropertyValue'
    'Get-RelativePath'
    'Get-StrictModeVersion'
    'Get-X509Certificate'
    'Get-X509CertificateCrlDistributionPoints'
